...
export type Pipeline = {
  asr: (audio: Uint8Array, from: LanguageCode, mode: SessionMode) => Promise<{ text: string; lang: LanguageCode }>;
  mt: (text: string, from: LanguageCode, to: LanguageCode) => Promise<{ text: string; lang: LanguageCode }>;
  tts: (text: string, lang: LanguageCode, voicePreset: string) => Promise<{ bytes: Uint8Array; lang: LanguageCode }>;
};
