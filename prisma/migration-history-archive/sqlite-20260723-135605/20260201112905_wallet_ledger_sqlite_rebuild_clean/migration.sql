/*
  ...
  - You are about to drop the column `updatedAt` on the `AdminCelebrationControls` table. All the data in the column will be lost.
  - You are about to alter the column `config` on the `AdminCelebrationControls` table. The data in that column could be lost. The data in that column will be cast from `Unsupported("json")` to `Json`.
  - You are about to drop the column `spamDiscarded` on the `CelebrationEIRollup5m` table. All the data in the column will be lost.
  - You are about to alter the column `moodVec` on the `CelebrationEIRollup5m` table. The data in that column could be lost. The data in that column will be cast from `Unsupported("json")` to `Json`.
  - You are about to alter the column `meta` on the `CelebrationReaction` table. The data in that column could be lost. The data in that column will be cast from `Unsupported("json")` to `Json`.
  - You are about to alter the column `meta` on the `EmmlEvent` table. The data in that column could be lost. The data in that column will be cast from `Unsupported("json")` to `Json`.
  - You are about to alter the column `meta` on the `EmmlReading` table. The data in that column could be lost. The data in that column will be cast from `Unsupported("json")` to `Json`.
  - You are about to alter the column `meta` on the `EmotionEvent` table. The data in that column could be lost. The data in that column will be cast from `Unsupported("json")` to `Json`.
  - You are about to alter the column `tags` on the `ReflectionJournal` table. The data in that column could be lost. The data in that column will be cast from `Unsupported("json")` to `Json`.
  - You are about to drop the column `lastEntry` on the `ShadowGarden` table. All the data in the column will be lost.
  - You are about to alter the column `entries` on the `ShadowGarden` table. The data in that column could be lost. The data in that column will be cast from `Unsupported("json")` to `Json`.
  ...
  - You are about to drop the column `createdAt` on the `persona_assets` table. All the data in the column will be lost.
  - You are about to alter the column `meta` on the `persona_assets` table. The data in that column could be lost. The data in that column will be cast from `Unsupported("json")` to `Json`.
  - You are about to drop the column `createdAt` on the `persona_reaction_mappings` table. All the data in the column will be lost.
  - You are about to alter the column `meta` on the `persona_reaction_mappings` table. The data in that column could be lost. The data in that column will be cast from `Unsupported("json")` to `Json`.
...
INSERT INTO "new_AdminCelebrationControls" ("config", "id") SELECT "config", "id" FROM "AdminCelebrationControls";
...
INSERT INTO "new_CelebrationEIRollup5m" ("celebrationId", "eiScore", "id", "moodVec", "reactions", "windowStart") SELECT "celebrationId", "eiScore", "id", "moodVec", "reactions", "windowStart" FROM "CelebrationEIRollup5m";
...
INSERT INTO "new_ShadowGarden" ("entries", "id") SELECT "entries", "id" FROM "ShadowGarden";
...
INSERT INTO "new_persona_assets" ("code", "emotion", "height", "id", "isActive", "kind", "label", "localPath", "meta", "mimeType", "profileId", "sortOrder", "updatedAt", "url", "width") SELECT "code", "emotion", "height", "id", "isActive", "kind", "label", "localPath", "meta", "mimeType", "profileId", "sortOrder", "updatedAt", "url", "width" FROM "persona_assets";
...
INSERT INTO "new_persona_reaction_mappings" ("assetCode", "emotion", "id", "intensity", "isActive", "meta", "profileId", "reaction", "updatedAt") SELECT "assetCode", "emotion", "id", "intensity", "isActive", "meta", "profileId", "reaction", "updatedAt" FROM "persona_reaction_mappings";
