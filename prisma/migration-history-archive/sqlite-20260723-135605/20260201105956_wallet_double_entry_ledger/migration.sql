...
CREATE TABLE "WalletLedger" (
    ...
    "refId" TEXT NOT NULL,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "WalletLedger_walletId_fkey" FOREIGN KEY ("walletId") REFERENCES "Wallet" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE UNIQUE INDEX "WalletLedger_source_refId_key" ON "WalletLedger"("source", "refId");
