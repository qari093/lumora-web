...
export default function HoloPanel({ enablePulse = false, externalPrompt }: Props) {
  ...
  const animForEmoji = useCallback(
    (emojiChar: string, perEmojiFallback?: Anim): Anim => {
      ...
      const moodMap = currentMood
        ? { [currentMood]: getAnimationsForMood(currentMood as any) }
        : {};
      return (
        (animForEmojiDefault({ emoji: emojiChar } as any, currentMood, moodMap as any) as Anim) ||
      ...
      <style jsx>{`
        ...
        @keyframes beat {
          ...
          25% {
            ...
            filter: drop-shadow(0 0 6px rgba(255, 0, 80, 0.35));
          }
          50% {
        ...
        .glyph[data-anim='zap'] {
          animation: em_zap 0.9s cubic-bezier(0.3, 0.7, 0.2, 1) infinite;
          display: inline-block;
        }
        @keyframes em_zap {
          0% {
          ...
          20% {
            ...
            filter: drop-shadow(0 0 12px rgba(255, 255, 0, 0.65));
          }
          40% {
