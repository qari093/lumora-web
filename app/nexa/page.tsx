...
export default function Page() {
  const items = [
    { id: "seed-1", title: "NEXA Seed 1", subtitle: "Baseline content", href: "#" },
    { id: "seed-2", title: "NEXA Seed 2", subtitle: "Non-empty guard", href: "#" },
    { id: "seed-3", title: "NEXA Seed 3", subtitle: "Render map", href: "#" },
  ] as const;

    return (
    <>{/* LUMORA_PORTAL_ALIVE_NEXA */}<span style={{display:"none"}}>LUMORA_PORTAL_ALIVE_NEXA</span><main style={{ padding: 24 }}>
      ...
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>NEXA</h1>
      <p style={{ opacity: 0.8 }}>
