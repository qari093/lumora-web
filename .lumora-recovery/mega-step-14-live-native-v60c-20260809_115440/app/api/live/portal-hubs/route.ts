...
export async function GET() {
  ...
  try {
    const hubs: Hub[] = [
      { id: "hub_live", title: "Live", slug: "live", live: true, order: 1, href: "/live", icon: "live" },
      { id: "hub_gmar", title: "GMAR", slug: "gmar", live: false, order: 2, href: "/gmar", icon: "gmar" },
      { id: "hub_nexa", title: "NEXA", slug: "nexa", live: false, order: 3, href: "/nexa", icon: "nexa" },
      { id: "hub_music", title: "Music", slug: "music", live: false, order: 4, href: "/music", icon: "music" },
